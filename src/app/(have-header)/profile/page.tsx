        ...
        <img src="https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" />
          ...
          <FormProvider {...form}>
              <form onSubmit={handleSubmit} className='basis-2/3 bg-white p-14 pl-20 pr-20 rounded-lg'>
                  ...
                  <button onClick={handleSubmit} type="button" className="bg-green-600 text-white px-6 py-2 rounded font-medium mt-4 hover:bg-green-700 transition duration-200 each-in-out">Edit</button>
              </form>
          </FormProvider>
      </div>
  </div>
